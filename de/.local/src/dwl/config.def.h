...
static const Rule rules[] = {
	...
	{ "Gimp_EXAMPLE",     NULL,       0,            0,            1,           -1,       0,  0,  1000,   0.75 }, /* Start on currently visible tags floating, not tiled */
	{ "firefox_EXAMPLE",  NULL,       1 << 8,       1,            0,           -1,       0,  0,  0,      0    },/* Start on ONLY tag "9" */
};
...
static const Key keys[] = {
  ...
  { 1, {{ MODKEY,                    XKB_KEY_b}},  togglebar,      {0} },
...
TAGKEYS( XKB_KEY_9, XKB_KEY_parenleft,   8 ),
	...
	{ 1,{{MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Q}},          quit,           {0} },
