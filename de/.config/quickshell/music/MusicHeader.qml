...
Item {
    ...
    Image {
        ...
        source: root.art
        sourceSize.width: Ui.s(96) * 2
        sourceSize.height: Ui.s(96) * 2
    ...
    Column {
        ...
        anchors.leftMargin: art.visible ? Ui.s(12) : 0
        ...
        Item {
            ...
            Rectangle {
                id: track
                anchors.verticalCenter: parent.verticalCenter
                width: parent.width - elapsedLabel.width - Ui.s(10)
                height: Ui.s(4)
